...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/usr/local/bin/git" rev-parse "${ref}^0"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/usr/local/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/usr/local/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/local/bin/git" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
...
if(need_stash)
  execute_process(
    COMMAND "/usr/local/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/usr/local/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/usr/local/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/alex/Documents/PJATK/HelloSFML/cmake-build-debug/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
